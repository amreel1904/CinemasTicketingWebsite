...
<body class="sb-nav-fixed">
		...
		<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
			<li class="nav-item dropdown"><a
				...
				<ul class="dropdown-menu dropdown-menu-end"
					...
					<li><a class="dropdown-item" href="http://localhost:8080/MovieTicketBookingSystem/AdminSys/LogIn.jsp">Logout</a></li>
				</ul></li>
		</ul>
		</li>
		</ul>
						...
						<div class="overlay" id="overlay">
							<div class="popup-form" id="popupForm">
								...
								<div class="form-scroll">
									<form action="../MoviesCon" method="post">
  ...
  function displayImg(input) {
    var preview = document.getElementById('cover_img');
    ...
    if (file) {
      ...
      preview.src = '../assets/img/';
						...
						<div class="card-body">
							<table id="customers" class="table table-bordered" id="data-table">
								<tr>
									<th>No.</th>
									<th>Title</th>
									<th>Description</th>
